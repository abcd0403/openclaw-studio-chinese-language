  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-2 px-1">
        <p className="console-title type-page-title text-foreground">{t("Agents")} ({agents.length})</p>
        <button
          type="button"
        ...
        >
          {createBusy ? t("Creating...") : t("New agent")}
        </button>
      </div>
      ...
      <div ref={scrollContainerRef} className="ui-scroll min-h-0 flex-1 overflow-auto">
        {agents.length === 0 ? (
          <EmptyStatePanel title={t("No agents available.")} compact className="p-3 text-xs" />
        ) : (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-1.5 flex flex-wrap items-center gap-2">
                      ...
                      >
                        {t(resolveAgentStatusLabel(agent.status))}
                      </span>
